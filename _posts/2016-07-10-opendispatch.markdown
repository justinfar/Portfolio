...
<p>As it stood, the mobile application that was being used was built in such a way that it needed to support specific PDA devices. Now that the client was using Android phones, it was decided that the product team needed to address the painpoints of the previous experience whilst also translate the experience onto the Android ecosystem.</p>
<br />
...
<!-- People -->
<h2 style="color: #23E16C;">Understanding the people and the space </h2>
